    ...
    <div class="card text-white bg-secondary mb-3 cardInicio">
        ...
        <div class="card-body">
            ...
            <div class="mb-1 w-100">
                <form  method="POST" action="{{ route('sale.store') }}" id="userForm" class="d-flex flex-column align-items-center">   <label for="productoCode"
                id="productoCodeLabel" name="productoCodeLabel" class="form-label labelRegister">Codigo
                @csrf
